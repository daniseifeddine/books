            ...
            <div>
                <div class="box-1 p-1 rounded flex content-center items-center gap-2">
                    ...
                    <div>
                        ...
                        <form action="{{ route('UpdateImageAdmin') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                        ...
                        @if ($user->ProfileImage)
                            <form action="{{ route('RemoveImageAdmin') }}" method="POST">
                                @csrf
                                @method('delete')
                                <button type="submit"
                ...
                <form action="{{ route('user_info_admin') }}" method="POST" class="p-2">
                    @csrf
                    @method('post')
